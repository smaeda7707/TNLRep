...
{
    public class HaloDraw : PlayerDrawLayer
    {
        ...
        public override bool GetDefaultVisibility(PlayerDrawSet drawInfo)
        {
            ...
            return (drawInfo.drawPlayer.HasBuff<Halo>());
        ...
        {
            exampleItemTexture = ModContent.Request<Texture2D>("NewLoot/Common/HaloFirstFrame");

            var position = drawInfo.Center + new Vector2(0f, -23f) - Main.screenPosition;
