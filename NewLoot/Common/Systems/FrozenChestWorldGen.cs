...
{
    public class FrozenChestWorldGen : ModSystem
    {
        ...
        public override void PostWorldGen()
        {
            ...
            int[] itemsToPlaceInWaterChests = { ModContent.ItemType<FrozenBoomerang>(), ModContent.ItemType<IceTrinket>(), ModContent.ItemType<FrostChain>(), ModContent.ItemType<IceRapier>()};
            ...
            for (int chestIndex = 0; chestIndex < Main.maxChests; chestIndex++)
            {
                ...
                if (chestTile.TileType == TileID.Containers && chestTile.TileFrameX == 11 * 36)
                {
                    ...
                    {
                        if (chest.item[inventoryIndex].type == ItemID.FlurryBoots || chest.item[inventoryIndex].type == ItemID.IceBoomerang || chest.item[inventoryIndex].type == ItemID.IceBlade || chest.item[inventoryIndex].type == ItemID.SnowballCannon)
                        {
                            // Place the item
