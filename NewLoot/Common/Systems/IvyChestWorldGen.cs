...
{
    public class IvyChestWorldGen : ModSystem
    {
        ...
        public override void PostWorldGen()
        {
            ...
            int[] itemsToPlaceInWaterChests = { ModContent.ItemType<BambooGun>(), ModContent.ItemType<CursedTotem>(), ModContent.ItemType<JungleTrinket>()};
            ...
            for (int chestIndex = 0; chestIndex < Main.maxChests; chestIndex++)
            {
                ...
                if (chestTile.TileType == TileID.Containers && chestTile.TileFrameX == 10 * 36)
                {
                    ...
                    {
                        if (chest.item[inventoryIndex].type == ItemID.AnkletoftheWind || chest.item[inventoryIndex].type == ItemID.FeralClaws || chest.item[inventoryIndex].type == ItemID.Boomstick)
                        {
                            // Place the item
