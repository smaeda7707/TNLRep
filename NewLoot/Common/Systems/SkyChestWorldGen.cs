...
{
    public class SkyChestWorldGen : ModSystem
    {
        ...
        public override void PostWorldGen()
        {
            ...
            int[] itemsToPlaceInWaterChests = { ModContent.ItemType<WindCharge>(), ModContent.ItemType<SpacedustGun>(), ModContent.ItemType<AngelStaff>()};
            ...
            for (int chestIndex = 0; chestIndex < Main.maxChests; chestIndex++)
            {
                ...
                if (chestTile.TileType == TileID.Containers && chestTile.TileFrameX == 13 * 36)
                {
                    ...
                    {
                        if (chest.item[inventoryIndex].type == ItemID.Starfury || chest.item[inventoryIndex].type == ItemID.ShinyRedBalloon || chest.item[inventoryIndex].type == ItemID.LuckyHorseshoe || chest.item[inventoryIndex].type == ItemID.CelestialMagnet)
                        {
                            // Place the item
