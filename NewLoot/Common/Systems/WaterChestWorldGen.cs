...
{
    public class WaterChestWorldGen : ModSystem
    {
        ...
        public override void PostWorldGen()
        {
            ...
            int[] itemsToPlaceInWaterChests = { ModContent.ItemType<OceanWhip>(), ModContent.ItemType<AquaBook>(), ModContent.ItemType<OceanTrinket>() };
            ...
            for (int chestIndex = 0; chestIndex < Main.maxChests; chestIndex++)
            {
                ...
                if (chestTile.TileType == TileID.Containers && chestTile.TileFrameX == 17 * 36)
                {
                    ...
                    {
                        if (chest.item[inventoryIndex].type == ItemID.Trident || chest.item[inventoryIndex].type == ItemID.WaterWalkingBoots || chest.item[inventoryIndex].type == ItemID.BreathingReed || chest.item[inventoryIndex].type == ItemID.FloatingTube)
                        {
                            // Place the item
