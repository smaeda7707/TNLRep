...
namespace NewLoot.Common.UI.energyUI
{
    ...
    internal class EnergyBar : UIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            barFrame = new UIImage(ModContent.Request<Texture2D>("NewLoot/Common/UI/EnergyBarFrame")); // Frame of our resource bar
            ...
            gradientA = new Color(52, 235, 73); // A dark purple
            gradientB = new Color(140, 230, 150); // A light purple
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            var modPlayer = Main.LocalPlayer.GetModPlayer<Energy>();
            // Calculate quotient
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            text.SetText(EnergyUISystem.EnergyText.Format(modPlayer.energyCurrent, modPlayer.energyMax2));
    ...
    internal class EnergyUISystem : ModSystem
    {
        ...
        public override void Load()
        {
            ...
            string category = "UI";
            EnergyText ??= Language.GetOrRegister(Mod.GetLocalizationKey($"{category}.Energy"));
        }
