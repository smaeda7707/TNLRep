...
{
    public class OceanWhipDebuff : ModBuff
    {
    ...
    public class OceanWHipNPC : GlobalNPC
    {
        public override void ModifyHitByProjectile(NPC npc, Projectile projectile, ref NPC.HitModifiers modifiers)
        {
            ...
            if (npc.HasBuff<OceanWhipDebuff>())
            {
                // Apply a flat bonus to every hit
                modifiers.FlatBonusDamage += OceanWhipDebuff.TagDamage * projTagMultiplier;
            }
