...
namespace NewLoot.Content.Items.Accessories
{
    ...
    public class CorruptGauntlet : ModItem
    {
        ...
        {
            player.GetModPlayer<CorruptGauntletPlayer>().CorruptGauntletAccessoryEquipped = true;
        }
    ...
    public class CorruptGauntletPlayer : ModPlayer
    {
        ...
        public bool CorruptGauntletAccessoryEquipped;
        ...
        public override void ResetEffects()
        {
            ...
            CorruptGauntletAccessoryEquipped = false;
        ...
        {
            return CorruptGauntletAccessoryEquipped
