...
namespace NewLoot.Content.Items.Accessories
{
    public class SubZero : ModItem
    {
        ...
        {
            player.GetModPlayer<SubZeroPlayer>().SubZeroEquipped = true;
            ...
            {
                player.AddBuff(ModContent.BuffType<SubZeroBuff>(), 1500);
    ...
    public class SubZeroPlayer : ModPlayer
    {

        // The fields related to the dash accessory
        public bool SubZeroEquipped;

        public override void ResetEffects()
        {
            // Reset our equipped flag. If the accessory is equipped somewhere, ExampleShield.UpdateAccessory will be called and set the flag before PreUpdateMovement
            SubZeroEquipped = false;
