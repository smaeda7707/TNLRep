...
{
    internal class MagtaneBar : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.MagtaneBarTile>());
        }
        public override void AddRecipes()
        {
            Recipe recipe = CreateRecipe(); // Creates Recipe
            recipe.AddIngredient(ModContent.ItemType<MagtaneOre>(), 4);
