...
{
    internal class CoriteCannon : ModItem
    {
        public static int gunLoad = 0;
        private int reloadUseSpeed = 55;
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            else
            {
                ...
                {
                    Projectile.NewProjectileDirect(source, position, velocity, type = ModContent.ProjectileType<CoriteBomb>(), damage, knockback, player.whoAmI);
                    gunLoad -= 1;
                }
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            if (player.altFunctionUse == 2)
            {
                ...
                {
                    Item.GetGlobalItem<GlobalFields>().energyCost = 70;
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<CoriteBar>(), 15)
