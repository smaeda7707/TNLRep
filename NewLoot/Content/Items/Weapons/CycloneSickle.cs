...
{
    public class CycloneSickle : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            // Weapon Properties
            Item.knockBack = 7f;  // The knockback of your sword, this is dynamically adjusted in the projectile code.
            Item.autoReuse = true; // This determines whether the weapon has autoswing
            Item.damage = 37; // The damage of your sword, this is dynamically adjusted in the projectile code.
        ...
        public override bool CanUseItem(Player player)
        {
            if (player.altFunctionUse == 2)
            {
                Item.GetGlobalItem<GlobalFields>().energyCost = 62;
                Item.useTime = 300;
                Item.useAnimation = 300;
                Item.UseSound = SoundID.DD2_MonkStaffSwing;
                Item.shoot = ModContent.ProjectileType<CycloneSickleProjSecondary>();
            ...
            else
            {
                ...
                Item.shoot = ModContent.ProjectileType<CycloneickleProjectile>();
