...
{
    public class KanumSickle : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            // Weapon Properties
            Item.knockBack = 6.75f;  // The knockback of your sword, this is dynamically adjusted in the projectile code.
            Item.autoReuse = true; // This determines whether the weapon has autoswing
            Item.damage = 26; // The damage of your sword, this is dynamically adjusted in the projectile code.
            Item.DamageType = DamageClass.Melee; // Deals melee damage
            Item.noMelee = true;  // This makes sure the item does not deal damage from the swinging animation
            Item.noUseGraphic = true; // This makes sure the item does not get shown when the player swings his hand

            // Projectile Properties
            Item.shoot = ModContent.ProjectileType<KanumSickleProjectile>(); // The sword as a projectile
        }
        ...
        public override bool CanUseItem(Player player)
        {
            if (player.altFunctionUse == 2)
            {
                ...
                Item.shoot = ModContent.ProjectileType<KanumSickleProjectileSecondary>();
            ...
            else
            {
                ...
                Item.shoot = ModContent.ProjectileType<KanumSickleProjectile>();
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<KanumBar>(), 14)
