...
{
    internal class MagtaneRepeater : ModItem
    {
        public static int repeaterMaxShots;
        public static int magtaneRepeaterShots = 0;
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<MagtaneBar>(), 12)
        ...
        public override bool? UseItem(Player player)
        {
            ...
            {
                magtaneRepeaterShots = RepeaterGlobal.RepeaterUse(player, magtaneRepeaterShots, repeaterMaxShots, overheatTime,shotIncrease, false);
            }
            return true;
        }
        ...
        public override void UpdateInventory(Player player)
        {
            ...
            magtaneRepeaterShots = RepeaterGlobal.RepeaterUpdate(player, magtaneRepeaterShots, repeaterMaxShots, heatRegenRate, count);
        }
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            if (player.altFunctionUse == 2)
            {
                Projectile.NewProjectileDirect(source, position, velocity *= 0, type = ModContent.ProjectileType<MagtaneRepeaterExplosion>(), damage * 4, knockback *= 2, player.whoAmI);
            }
            else
            {
                // Create a projectile.
