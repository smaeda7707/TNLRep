...
{
    internal class QueenSlimeGun : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shootSpeed = 12.8f; // The speed of the projectile (measured in pixels per frame.)
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            {
                Item.GetGlobalItem<GlobalFields>().energyCost = 3;
                Item.useTime = 6;
                Item.useAnimation = 6;
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            if (player.altFunctionUse == 2)
            {
                if (random == 1)
                {
                    Projectile.NewProjectileDirect(source, position, velocity * 2f, type = ModContent.ProjectileType<QueenSlimeBallBigNavy>(), (int)(damage * 1.1f), knockback, player.whoAmI);
                }
                else if (random == 2)
                {
                    Projectile.NewProjectileDirect(source, position, velocity * 2f, type = ModContent.ProjectileType<QueenSlimeBallBigPink>(), (int)(damage * 1.1f), knockback, player.whoAmI);
                }
                else
                {
                    Projectile.NewProjectileDirect(source, position, velocity * 2f, type = ModContent.ProjectileType<QueenSlimeBallBigPurple>(), (int)(damage * 1.1f), knockback, player.whoAmI);
                }
            ...
            else
            {
                ...
                {
                    // Create a projectile.
                    Projectile.NewProjectileDirect(source, position, velocity, type = ModContent.ProjectileType<QueenSlimeBallNavy>(), damage, knockback, player.whoAmI);
                }
                else if (random == 2)
                {
                    // Create a projectile.
                    Projectile.NewProjectileDirect(source, position, velocity, type = ModContent.ProjectileType<QueenSlimeBallPink>(), damage, knockback, player.whoAmI);
                }
                else
                {
                    // Create a projectile.
                    Projectile.NewProjectileDirect(source, position, velocity, type = ModContent.ProjectileType<QueenSlimeBallPurple>(), damage, knockback, player.whoAmI);
                }
            }
