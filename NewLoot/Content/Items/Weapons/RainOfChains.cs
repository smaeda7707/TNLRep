...
{
    internal class RainOfChains : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.DefaultToStaff(ModContent.ProjectileType<AquaRing>(), 5, 24, 4); // (Shoot speed, use time, mana)
            Item.width = 28;
            Item.height = 30;
            ...
            Item.SetWeaponValues(20, 3.1f, 0); //(Damage,Knockback,CritChance)
