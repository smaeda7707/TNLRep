...
{
    internal class SlimeMace : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.knockBack = 6.25f; // The knockback of your flail, this is dynamically adjusted in the projectile code.
            ...
            Item.shoot = ModContent.ProjectileType<SlimeMaceProjectile>(); // The flail projectile
            Item.shootSpeed = 10.5f; // The speed of the projectile measured in pixels per frame.
            ...
            Item.value = Item.sellPrice(gold: 0, silver: 70); // Sells for 2 gold 50 silver
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            else
            {
                ...
                Item.useTime = 45;
                Item.shoot = ModContent.ProjectileType<SlimeMaceProjectile>();
        ...
        public override bool? UseItem(Player player)
        {
            if (player.altFunctionUse == 2)
            {
                player.AddBuff(ModContent.BuffType<SlimeMaceBuff>(), 480);
                var Resource = player.GetModPlayer<Energy>();
