...
namespace NewLoot.Content.Projectiles
{
    ...
    public class BloodSickleProjectile : ModProjectile
    {
        ...
        private const float SWINGRANGE = 1.2f * (float)Math.PI; // The angle a swing attack covers (300 deg) (DEFAULT 1f)
        ...
        public override string Texture => "NewLoot/Content/Items/Weapons/BloodSickle"; // Use texture of item as projectile texture
        ...
        {
            if (Main.player[Projectile.owner].GetModPlayer<BloodStealPlayer>().on)
            {
