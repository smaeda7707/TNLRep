...
{
    internal class BubbleYoyoProj : ModProjectile
    {
        public static int mode;
        public static Vector2 bubbleYoyoPos;
        public override void SetStaticDefaults()
        {
            ...
            ProjectileID.Sets.YoyosMaximumRange[Projectile.type] = 195f;

            // YoyosTopSpeed is top speed of the yoyo Projectile.
            // Vanilla values range from 9f (Wood) to 17.5f (Terrarian), and defaults to 10f.
            ProjectileID.Sets.YoyosTopSpeed[Projectile.type] = 11.1f;
        }
        ...
        public override void AI()
        {
            ...
            bubbleYoyoPos = Projectile.Center;
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            if (mode == 0)
            {
                Projectile.NewProjectileDirect(Projectile.GetSource_FromThis(), Projectile.position, Projectile.velocity * 0, ModContent.ProjectileType<Bubble>(), Projectile.damage * 2, Projectile.knockBack / 2, 0, 1);
                mode ++;
                if (Main.player[Projectile.owner].HasBuff(ModContent.BuffType<BubbleExpand>()))
                {
                    mode++;
                }
            }
