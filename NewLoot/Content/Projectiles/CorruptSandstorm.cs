...
{
    internal class CorruptSandstorm : ModProjectile
    {
        public override void SetDefaults()
        {
            ...
            Projectile.localNPCHitCooldown = 23;// the cooldown between hits (For local NPC i frames)
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextBool(2))
            {
                for (int i = 0; i < 16; i++)
                {
                    ...
                    Color dustColor = Color.Lerp(Color.MediumPurple, Color.Magenta, Main.rand.NextFloat() * 0.3f);
            ...
            if (Main.rand.NextBool(4))
            {
                for (int i = 0; i < 8; i++)
                {
                    ...
                    Color dustColor2 = Color.Lerp(Color.MediumPurple, Color.Magenta, Main.rand.NextFloat() * 0.3f);
