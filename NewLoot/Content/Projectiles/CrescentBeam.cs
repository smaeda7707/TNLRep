...
{
    internal class CrescentBeam : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextBool(2))
            {
                ...
                {
                    Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.WaterCandle, Projectile.velocity.X * 0.1f, Projectile.velocity.Y * 0.1f,
                        40, default, 1f);
                }
