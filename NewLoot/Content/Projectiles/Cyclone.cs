...
{
    internal class Cyclone : ModProjectile
    {
        public override string Texture => "NewLoot/Content/Projectiles/Whirlwind";
        ...
        public override void AI()
        {
            ...
            if (!CycloneSickleProjSecondary.alive && !CycloneickleProjectile.alive)
            {
                Projectile.Kill();
            }
