...
namespace NewLoot.Content.Projectiles
{
    ...
    public class CycloneSickleProjSecondary : ModProjectile
    {
        ...
        private const float SPINRANGE = 70.0f * (float)Math.PI; // The angle a spin attack covers (630 degrees)
        ...
        private const float SPINTIME = 31f; // How much longer a spin is than a swing (DEFAULT 3.1f)
        ...
        public override string Texture => "NewLoot/Content/Items/Weapons/CycloneSickle"; // Use texture of item as projectile texture
        ...
        {
            Main.player[Projectile.owner].AddBuff(ModContent.BuffType<CyclonePower>(), 1);
            alive = true;
