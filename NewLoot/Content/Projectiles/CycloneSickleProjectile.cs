...
namespace NewLoot.Content.Projectiles
{
    ...
    public class CycloneickleProjectile : ModProjectile
    {
        public static bool alive;
        private int timer;
        private bool spinCheck;
        ...
        private const float SWINGRANGE = 1.25f * (float)Math.PI; // The angle a swing attack covers (300 deg) (DEFAULT 1f)
        ...
        private const float SPINTIME = 3.5f; // How much longer a spin is than a swing (DEFAULT 3.1f)
        ...
        public override void AI()
        {
            ...
            if (timer == 30 && spinCheck)
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position, Projectile.velocity * 0, ModContent.ProjectileType<Cyclone>(), Projectile.damage / 6, 5.8f);
            }
