...
namespace NewLoot.Content.Projectiles
{
    ...
    public class DarkGlaiveProjSecondary : ModProjectile
    {
        ...
        private const float SWINGRANGE = 1.1f * (float)Math.PI; // The angle a swing attack covers (300 deg) (DEFAULT 1f)
        ...
        private float execTime => 4f / Owner.GetTotalAttackSpeed(Projectile.DamageType);
        ...
        public override void AI()
        {
            ...
            Color color = new Color(169, 70, 212);
            Lighting.AddLight(Projectile.TopRight, color.ToVector3() * 0.5f);
        }
