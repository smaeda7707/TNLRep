...
{
    internal class DungeonWhipProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Utils.GetLerpValue(0.1f, 0.7f, swingProgress, clamped: true) * Utils.GetLerpValue(0.9f, 0.7f, swingProgress, clamped: true) > 0.5f && !Main.rand.NextBool(3))
            {
                ...
                Dust dust = Dust.NewDustDirect(spawnArea.TopLeft(), spawnArea.Width, spawnArea.Height, dustType, 0f, 0f, 100, Color.Silver);
        ...
        {
            target.AddBuff(ModContent.BuffType<DungeonWhipDebuff>(), 240);
        ...
        {
            if (Main.rand.NextBool(100 / Projectile.CritChance))
            {
                modifiers.SetCrit();
            }
        }
        ...
        {
            Color colorUse = new Color(14, 28, 44);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < list.Count - 1; i++)
            {
                ...
                if (i == list.Count - 2)
                {
                    ...
                    frame.Y = 116; // Distance from the top of the sprite to the start of the frame.
    ...
    internal class DungeonWhipProjSecondary : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Utils.GetLerpValue(0.1f, 0.7f, swingProgress, clamped: true) * Utils.GetLerpValue(0.9f, 0.7f, swingProgress, clamped: true) > 0.5f && !Main.rand.NextBool(3))
            {
                ...
                // After choosing a randomized dust and a whip segment to spawn from, dust is spawned.
                Dust dust = Dust.NewDustDirect(spawnArea.TopLeft(), spawnArea.Width, spawnArea.Height, dustType, 0f, 0f, 100, Color.Crimson);
                dust.position = points[pointIndex];
                dust.fadeIn = 0.3f;
                Vector2 spinningpoint = points[pointIndex] - points[pointIndex - 1];
                dust.noGravity = true;
