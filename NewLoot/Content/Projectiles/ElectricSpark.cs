...
{
    internal class ElectricSpark : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Dust coloredDust = Dust.NewDustPerfect(Projectile.Center + dustRotation.ToRotationVector2() * (Main.rand.NextFloat() * 0.1f * Projectile.scale * Projectile.scale), DustID.Electric, dustVelocity * Main.rand.NextFloat(3, 8), 100, dustColor, 0.4f);
