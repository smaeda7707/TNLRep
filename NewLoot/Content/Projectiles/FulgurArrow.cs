...
{
    internal class FulgurArrow : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                Dust dust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.InfluxWaver, 0f, 0f, 100, default, 2f);
                dust.velocity *= 0.3f;
                dust.noGravity = true;
            }
        }
