...
{
    internal class HoneyLanceProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            float extendDist = 17; // How far to fly out during extension (USE 86 - (Sprite WIDTH or HEIGHT))
            ...
            if (playerVelocity > minimumDustVelocity && movementInLanceDirection > 0.8f)
            {
                ...
                int dustTypeCommon = DustID.Honey;
                int dustTypeRare = DustID.Honey2;
    ...
    internal class HoneyLanceProjSecondary : ModProjectile
    {
        private bool cursor;
        ...
        {
            // This will increase or decrease the knockback of the Jousting Lance depending on how fast the player is moving.
            modifiers.Knockback *= Main.player[Projectile.owner].velocity.Length() / 9f;
            // This will increase or decrease the damage of the Jousting Lance depending on how fast the player is moving.
            modifiers.SourceDamage *= 0.1f + Main.player[Projectile.owner].velocity.Length() / 7f * 0.9f;


            modifiers.SetMaxDamage(340);
        }
        ...
        private void Visuals()
        {
            ...
            if (Projectile.frameCounter >= frameSpeed && Projectile.frame < 3)
            {
