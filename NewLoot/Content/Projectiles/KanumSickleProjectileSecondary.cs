...
namespace NewLoot.Content.Projectiles
{
    ...
    public class KanumSickleProjectileSecondary : ModProjectile
    {
        ...
        private const float SPINRANGE = 7.0f * (float)Math.PI; // The angle a spin attack covers (630 degrees)
        ...
        private const float SPINTIME = 3.25f; // How much longer a spin is than a swing (DEFAULT 3.1f)
        ...
        public override string Texture => "NewLoot/Content/Items/Weapons/KanumSickle"; // Use texture of item as projectile texture
