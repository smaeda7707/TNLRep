...
{
    internal class LeafWhipProj : ModProjectile
    {
        public static float rangeMult = 0.8f;
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.WhipSettings.RangeMultiplier = rangeMult;
        ...
        public override void AI()
        {
            ...
            if (Main.player[Projectile.owner].GetModPlayer<NatureBuffPlayer>().natureBuffed == true)
            {
                rangeMult = 1.2f;
            }
            else
            ...
            if (Timer == swingTime / 2)
            {
                ...
                SoundEngine.PlaySound(SoundID.Grass, points[points.Count - 1]);
            }
            ...
            if (Utils.GetLerpValue(0.1f, 0.7f, swingProgress, clamped: true) * Utils.GetLerpValue(0.9f, 0.7f, swingProgress, clamped: true) > 0.5f && !Main.rand.NextBool(3))
            {
                ...
                Dust dust = Dust.NewDustDirect(spawnArea.TopLeft(), spawnArea.Width, spawnArea.Height, dustType, 0f, 0f, 100, Color.GreenYellow);
        ...
        {
            target.AddBuff(ModContent.BuffType<LeafWhipDebuff>(), 240);
