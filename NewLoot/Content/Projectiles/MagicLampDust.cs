...
namespace NewLoot.Content.Projectiles
{
    ...
    public class MagicLampDust : ModProjectile
    {
        ...
        private const float SPINTIME = 2.8f; // How much longer a spin is than a swing (DEFAULT 3.1f)
        ...
        public override void AI()
        {
            ...
            Dust coloredDust = Dust.NewDustPerfect(Projectile.Center + dustRotation.ToRotationVector2() * (Main.rand.NextFloat() * 1f * Projectile.scale + 40f * Projectile.scale), DustID.BlueTorch, dustVelocity * 1f, 100, dustColor, 0.4f);
