...
{
    internal class MagtaneJoustingLanceProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            float extendDist = 8; // How far to fly out during extension (USE 86 - (Sprite WIDTH or HEIGHT))
            ...
            if (playerVelocity > minimumDustVelocity && movementInLanceDirection > 0.8f)
            {
                ...
                int dustTypeCommon = DustID.GemDiamond;
