...
namespace NewLoot.Content.Projectiles.Minions
{
    ...
    public class EaterMinionBuff : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<EaterMinion>()] > 0)
            {
    ...
    public class EaterMinionItem : ModItem
    {
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            {
                Item.shoot = ModContent.ProjectileType<EaterMinion>(); // This item creates the minion projectile
    ...
    public class EaterMinion : ModProjectile
    {
        ...
        public sealed override void SetDefaults()
        {
            ...
            Projectile.localNPCHitCooldown = 35;// the cooldown between hits (For local NPC i frames)
        }
        ...
        private bool CheckActive(Player owner)
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<EaterMinionBuff>());

                return false;
            }

            if (owner.HasBuff(ModContent.BuffType<EaterMinionBuff>()))
            {
        ...
        private void Visuals()
        {
            ...
            {
                Projectile.rotation = Projectile.velocity.ToRotation() + MathHelper.PiOver4 + MathHelper.ToRadians(135);
            }
        }
    }
}
