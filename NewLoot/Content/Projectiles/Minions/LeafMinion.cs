...
namespace NewLoot.Content.Projectiles.Minions
{
    ...
    public class LeafMinionBuff : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<LeafMinion>()] > 0)
            {
    ...
    public class LeafMinionItem : ModItem
    {
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            {
                Item.GetGlobalItem<GlobalFields>().energyCost = 37;
            ...
            {
                Item.shoot = ModContent.ProjectileType<LeafMinion>(); // This item creates the minion projectile
        ...
        public override bool? UseItem(Player player)
        {
            if (player.altFunctionUse == 2)
            {
                player.AddBuff(ModContent.BuffType<RazorLeafs>(), 840);
                var exampleResourcePlayer = player.GetModPlayer<Energy>();
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = ModContent.BuffType<LeafMinionBuff>();
    ...
    public class LeafMinion : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.player[Projectile.owner].GetModPlayer<RazorLeafsPlayer>().active)
            {
        ...
        private bool CheckActive(Player owner)
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<LeafMinionBuff>());

                return false;
            }

            if (owner.HasBuff(ModContent.BuffType<LeafMinionBuff>()))
            {
        ...
        private void Visuals()
        {
            ...
            Projectile.rotation = (Projectile.velocity.X * 0.05f) - 1.5f;
