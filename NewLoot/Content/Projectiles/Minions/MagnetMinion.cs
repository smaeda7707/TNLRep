...
namespace NewLoot.Content.Projectiles.Minions
{
    ...
    public class MagnetMinionBuff : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<MagnetMinion>()] > 0)
            {
    ...
    public class MagnetMinionItem : ModItem
    {
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            {
                Item.shoot = ModContent.ProjectileType<MagnetMinion>(); // This item creates the minion projectile
        ...
        public override bool? UseItem(Player player)
        {
            if (player.altFunctionUse == 2)
            {
                player.AddBuff(ModContent.BuffType<MagneticCursor>(), 900);
                var exampleResourcePlayer = player.GetModPlayer<Energy>();
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = ModContent.BuffType<MagnetMinionBuff>();
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<CoriteBar>(), 4)
                .AddIngredient(ModContent.ItemType<MagtaneBar>(), 10)
    ...
    public class MagnetMinion : ModProjectile
    {
        ...
        private bool CheckActive(Player owner)
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<MagnetMinionBuff>());

                return false;
            }

            if (owner.HasBuff(ModContent.BuffType<MagnetMinionBuff>()))
            {
        ...
        private void Movement(bool foundTarget, float distanceFromTarget, Vector2 targetCenter, float distanceToIdlePosition, Vector2 vectorToIdlePosition)
        {
            ...
            if (Main.player[Projectile.owner].GetModPlayer<MagneticCursorPlayer>().cursorMagnet == true)
            {
                // The immediate range around the target (so it doesn't latch onto it when close)
                Vector2 direction = Main.MouseWorld - Projectile.Center;
                direction.Normalize();
                direction *= (speed * 1.75f);
