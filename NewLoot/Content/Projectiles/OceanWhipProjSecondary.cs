...
{
    internal class OceanWhipProjSecondary : ModProjectile
    {
        private object player;

        public override string Texture => "NewLoot/Content/Projectiles/OceanWhipProj";
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity*1.5f, ModContent.ProjectileType<OceanSwirl>(), Projectile.damage*2, Projectile.knockBack, Main.myPlayer);
                Projectile.ai[1]++;
            }
        }
