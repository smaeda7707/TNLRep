...
namespace NewLoot.Content.Projectiles
{
    ...
    public class SolarFuryProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            float scaleMulti = 1.8f; // Excalibur, Terra Blade, and The Horseman's Blade is 0.6f; True Excalibur is 1f; default is 0.2f 
            ...
            if (Main.rand.NextFloat() * 2f < Projectile.Opacity)
            {
                ...
                Color dustColor = Color.Lerp(Color.Orange, Color.OrangeRed, Main.rand.NextFloat() * 0.3f);
                Dust coloredDust = Dust.NewDustPerfect(Projectile.Center + dustRotation.ToRotationVector2() * (Main.rand.NextFloat() * 80f * Projectile.scale + 20f * Projectile.scale), DustID.SolarFlare, dustVelocity * 1f, 100, dustColor, 0.4f);
            ...
            if (Main.rand.NextFloat() * 1.5f < Projectile.Opacity)
            {
                ...
                Dust.NewDustPerfect(dustPosition, DustID.Torch, dustVelocity, 100, Color.Red * Projectile.Opacity, 1.2f * Projectile.Opacity);
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color backDarkColor = new Color(200, 44, 18); // Original Excalibur color: Color(180, 160, 60)
            Color middleMediumColor = new Color(254, 121, 2); // Original Excalibur color: Color(255, 255, 80)
            Color frontLightColor = new Color(253, 221, 3); // Original Excalibur color: Color(255, 240, 150)
