...
namespace NewLoot.Content.Projectiles
{
    internal class Spark : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Dust coloredDust = Dust.NewDustPerfect(Projectile.Center + dustRotation.ToRotationVector2() * (Main.rand.NextFloat() * 0.1f * Projectile.scale + 1f * Projectile.scale), DustID.Torch, dustVelocity * 1f, 100, dustColor, 0.4f);
