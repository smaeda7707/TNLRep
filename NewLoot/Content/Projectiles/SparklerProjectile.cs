...
{
    internal class SparklerProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            float extendDist = 10; // How far to fly out during extension (USE 86 - (Sprite WIDTH or HEIGHT))
            ...
            if (playerVelocity > minimumDustVelocity && movementInLanceDirection > 0.8f)
            {
                ...
                int dustTypeCommon = DustID.Torch;
                int dustTypeRare = DustID.Lava;
            ...
            if (Main.player[Projectile.owner].GetModPlayer<SparklingPlayer>().sparkling == true)
            {
                float vect1;
                float vect2;
                ...
                if (Main.rand.Next(12) == 0)
                {
                    ...
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.TopRight, launchVelocity, ModContent.ProjectileType<Spark>(), Projectile.damage / 2, Projectile.knockBack / 4, Main.myPlayer, 0, 1);
