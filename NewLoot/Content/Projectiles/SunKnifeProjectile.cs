...
{
	public class SunKnifeProjectile : ModProjectile
	{
        ...
        public override bool PreAI() {
			...
			if (Projectile.ai[1] == 100)
			{
                if (!shot)
                {
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity * 10, ModContent.ProjectileType<SunRings>(), (int) (Projectile.damage * 1.75f), Projectile.knockBack * 3, Main.myPlayer);
					shot = true;
                }
            }
        ...
        {
			if (Projectile.ai[1] == 200 && !exploded)
			{
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), target.Center, Projectile.velocity * 0, ModContent.ProjectileType<SunBurst>(), (int)Projectile.damage/2, 0, Main.myPlayer);
