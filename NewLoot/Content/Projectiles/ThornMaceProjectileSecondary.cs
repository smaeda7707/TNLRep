...
namespace NewLoot.Content.Projectiles
{
    ...
    internal class ThornMaceProjectileSecondary : ModProjectile
    {
        private const string ChainTexturePath = "NewLoot/Content/Projectiles/ThornMaceProjectileChain"; // The folder path to the flail chain sprite
        private const string ChainTextureExtraPath = "NewLoot/Content/Projectiles/ThornMaceProjectileChain2";  // This texture and related code is optional and used for a unique effect
        ...
        public override void AI()
        {
                ...
                case AIState.LaunchingForward:
                    {
                        ...
                        if (player.controlUseItem) // If the player clicks, transition to the Dropping state
                        {
							...
							if (Main.myPlayer == Projectile.owner)
								Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity, ModContent.ProjectileType<ThornBall>(), Projectile.damage, Projectile.knockBack, Main.myPlayer);
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity*1.2f, ModContent.ProjectileType<ThornBall>(), Projectile.damage * 2, Projectile.knockBack, Main.myPlayer);
                Projectile.ai[1]++;
            }
			...
			*/
            ...
            if (Main.rand.NextBool(dustRate))
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.JungleGrass, 0f, 0f, 150, default(Color), 1.3f);
        }
