...
namespace NewLoot.Content.Projectiles
{
    ...
    internal class TyphoonProjectile : ModProjectile
    {
        ...
        {
            Projectile.type = ProjectileID.Flairon;
            return base.PreDrawExtras();
        }
        public override bool PreDraw(ref Color lightColor)
        {
            Projectile.type = ModContent.ProjectileType<TyphoonProjectile>();
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity, ProjectileID.Typhoon, Projectile.damage / 2, Projectile.knockBack, Main.myPlayer);
                Projectile.ai[1]++;
            }
        }
    }
